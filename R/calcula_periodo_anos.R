...
#' retorna uma string representando o período (ex.: `"2010-2023"` ou `"2015"`
#' se houver apenas um ano).
#'
#' @param banco Data frame que contém a coluna de anos.
#' @param ano_col Nome da coluna que contém os anos (sem aspas).
#'
#' @return String com o período calculado.
#' @export
#'
#' @examples
#' \dontrun{
