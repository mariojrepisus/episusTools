...
#' sensibilidade, especificidade, VPP, VPN e acurácia com seus respectivos
#' intervalos de confiança 95% e p-valores.
#'
#' @param banco Data frame com os dados.
#' @param exposicoes Vetor de nomes (strings) das variáveis de exposição.
#' @param desfechos Vetor de nomes (strings) das variáveis de desfecho.
#' @param pasta_results Caminho da pasta para salvar o resultado em CSV
#'   (opcional).
...
#'   (padrão: `c("Sim", "Não")`).
#'
#' @return Data frame com as métricas de acurácia para cada par
#'   exposição × desfecho.
#' @export
#'
#' @examples
#' \dontrun{
#'   analisando_acuracia(banco,
#'                       exposicoes = c("expo1", "expo2"),
#'                       desfechos  = c("desf1"))
#' }
...
#'
#' Calcula o p-valor bilateral de um teste Z comparando uma proporção
#' observada contra a hipótese nula de `prop`.
#'
